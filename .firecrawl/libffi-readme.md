...
wrapper script during configuration like so:
 ...
 path/to/configure CC=path/to/msvcc.sh CXX=path/to/msvcc.sh LD=link CPP="cl -nologo -EP" CXXCPP="cl -nologo -EP" CPPFLAGS="-DFFI\_BUILDING\_DLL"
...
See the git log for details at http://github.com/libffi/libffi.
 ...
 Add conditional target support for \_\_int128.
 Fix closures using FFI\_REGISTER ABI.
 Fix SH linker errors with \_\_USER\_LABEL\_PREFIX\_\_.
 ...
 Define WIN32\_LEAN\_AND\_MEAN before including windows.h.
 ...
 3.5.0 Jun-8-2025
 Add FFI\_VERSION\_STRING and FFI\_VERSION\_NUMBER macros, as well
 as ffi\_get\_version() and ffi\_get\_version\_number() functions.
 Add ffi\_get\_default\_abi() and ffi\_get\_closure\_size() functions.
 ...
 3.4.2 Jun-28-2021
 Add static trampoline support for Linux on x86\_64 and ARM64.
 ...
 Enable tmpdir override with the $LIBFFI\_TMPDIR environment variable.
 Enable compatibility with MSVC runtime stack checking.
 Reject float and small integer argument in ffi\_prep\_cif\_var().
 ...
 GNU compiler uses 80 bits (128 in memory) FFI\_GNUW64 ABI.
 ...
 Solaris and AIX.
 Work around LLVM/GCC interoperability issue on x86\_64.

 3.0.11 Apr-11-2012
 Lots of build fixes.
 Add support for variadic functions (ffi\_prep\_cif\_var).
 ...
 1.12 Nov-22-1996
 Added missing ffi\_type\_void, needed for supporting void return
 ...
 feedback. ffi\_mips.h is always installed. Many configuration

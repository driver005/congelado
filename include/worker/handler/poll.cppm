...
class PollHandler {
  public:
    ...
    static void poll(interfaces::io::IRequest &req, interfaces::io::IResponse &res) noexcept {
        ...
        //         if (!parsed.has_value()) {
        //             core::logger::error("worker/poll", "parse TaskInstance failed: {}",
        //             parsed.error()); res.set_status(interfaces::io::types::Status::INTERNAL_SERVER_ERROR);
        //             return;
        //         }
        //
    ...
    static void ack(interfaces::io::IRequest &req, interfaces::io::IResponse &res) noexcept {
        auto target = req.get_path();

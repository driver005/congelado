...
//
// Usage:
//   ExecutionHandler::bind(worker_ctx);
...
class ExecutionHandler {
  public:
    ...
    static void get_execution(interfaces::io::IRequest &req,
        ...
        //         }
        //         if (status != 200) {
        //             core::logger::error("worker/executions", "get {} failed status={}", body,
        //             status); res.set_status(interfaces::io::types::Status::INTERNAL_SERVER_ERROR); return;
        //         }
        //         reply(res, bytes_from(body));
        //     });
    }
  ...
  private:
    static void reply(interfaces::io::IResponse &res, std::vector<std::byte> bytes,

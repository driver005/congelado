...
extern "C"
{
    ...
    TF_CAPI_EXPORT unsigned char TF_SetXlaEnableLazyCompilation(unsigned char enable);
    ...
    TF_CAPI_EXPORT void TF_SetXlaConstantFoldingDisabled(unsigned char should_enable);

...
extern "C"
{
    ...
    typedef TP_Protocol_Server* (*TP_Protocol_CreateServerFn)(void* user_data, TF_Status* status);
...
#define TP_PROTOCOL_SERVER_STRUCT_SIZE TF_OFFSET_OF_END(TP_Protocol_Server, is_running_cb)
    } TP_Protocol_Server;
...
#define PR_PATCH 1
    ...
    static inline void TP_Protocol_SetCreateServerCallback(
        TP_Protocol* builder, TP_Protocol_CreateServerFn create_server_cb
    )
    {

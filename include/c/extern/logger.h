...
extern "C"
{
    ...
    typedef void (*TP_Logger_WriteFn)(
        void* user_data, TF_Logger_LogLevel level, const TF_TString* message
    );
...
#define TP_LOGGER_STRUCT_SIZE TF_OFFSET_OF_END(TP_Logger, required_cb)
    ...
    static inline void
    TP_Logger_SetRequiredCallback(TP_Logger* builder, TP_Logger_RequiredFn required_cb)
    {

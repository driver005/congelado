...
extern "C"
{
    ...
    typedef struct TF_Generator_ParameterOps
    {
        ...
        void (*get_name)(TF_Generator_Parameter* param_context, TF_String* out);
        ...
        void (*get_description)(TF_Generator_Parameter* param_context, TF_String* out);
        int (*get_position)(TF_Generator_Parameter* param_context);
        TF_TypeInfo* (*get_type)(TF_Generator_Parameter* param_context);
    } TF_Generator_ParameterOps;

#define TF_GENERATOR_PARAMETER_STRUCT_SIZE TF_OFFSET_OF_END(TF_Generator_ParameterOps, get_type)

    TF_CAPI_EXPORT void
    create_generator_parameter(TF_Generator_ParameterOps** ops, void** plugin_context, TF_Status* status);

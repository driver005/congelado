...
extern "C"
{
    ...
    typedef struct TF_TypeInfoOps
    {
        ...
        void (*get_name)(TF_TypeInfo* type_context, TF_String* out);
        ...
        void (*get_type_attr_name)(TF_TypeInfo* type_context, TF_String* out);
        int (*get_data_type)(TF_TypeInfo* type_context);

        bool (*is_read_only)(TF_TypeInfo* type_context);
        bool (*is_list)(TF_TypeInfo* type_context);
    } TF_TypeInfoOps;

#define TF_TYPEINFO_STRUCT_SIZE TF_OFFSET_OF_END(TF_TypeInfoOps, is_list)

    TF_CAPI_EXPORT void
    create_typeinfo(TF_TypeInfoOps** ops, void** plugin_context, TF_Status* status);

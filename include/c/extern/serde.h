...
extern "C"
{
    ...
    typedef TF_Status* (*TP_Serde_EncodeFn)(
        void* user_data, const TF_TString* value_json, TF_TString** out_encoded
    );
    typedef TF_Status* (*TP_Serde_DecodeFn)(
        void* user_data, const TF_TString* data, TF_TString** out_json
    );

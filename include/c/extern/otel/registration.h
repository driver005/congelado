...
static inline void TP_Otel_SetGetTracerProviderCallback(TP_Otel* builder, TP_Otel_GetTracerProviderFn get_tracer_provider_cb) {
  builder->get_tracer_provider_cb = get_tracer_provider_cb;
}

static inline void TP_Otel_SetGetMeterProviderCallback(TP_Otel* builder, TP_Otel_GetMeterProviderFn get_meter_provider_cb) {

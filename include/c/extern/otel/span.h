...
extern "C"
{
    ...
    typedef void (*TP_Otel_Span_SetAttributeFn)(
        void* user_data, const TF_TString* key, const TF_TString* value
    );
    typedef void (*TP_Otel_Span_SetStatusFn)(
        void* user_data, int status, const TF_TString* description
    );
...
#define TP_OTEL_SPAN_STRUCT_SIZE TF_OFFSET_OF_END(TP_Otel_Span, end_cb)
    ...
    static inline void TP_OtelSpan_SetSetAttributeCallback(
        TP_Otel_Span* builder, TP_Otel_Span_SetAttributeFn set_attribute_cb
    )
    {
    ...
    static inline void
    TP_OtelSpan_SetSetStatusCallback(TP_Otel_Span* builder, TP_Otel_Span_SetStatusFn set_status_cb)
    {

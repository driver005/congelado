...
#define TP_OTEL_HISTOGRAM_STRUCT_SIZE TF_OFFSET_OF_END(TP_Otel_Histogram, record_cb)
    ...
    static inline void
    TP_OtelHistogram_SetStructSize(TP_Otel_Histogram* builder, size_t struct_size)
    {
    ...
    static inline void TP_OtelHistogram_SetRecordCallback(
        TP_Otel_Histogram* builder, TP_Otel_Histogram_RecordFn record_cb
    )
    {

...
extern "C"
{
    ...
    typedef TP_Otel_Span* (*TP_Otel_Tracer_StartSpanFn)(
        void* user_data, const TF_TString* name, int kind, TF_Status* status
    );
...
#define TP_OTEL_TRACER_STRUCT_SIZE TF_OFFSET_OF_END(TP_Otel_Tracer, start_span_cb)
    ...
    static inline void TP_OtelTracer_SetStartSpanCallback(
        TP_Otel_Tracer* builder, TP_Otel_Tracer_StartSpanFn start_span_cb
    )
    {

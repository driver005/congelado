...
typedef void (*TP_Events_PublishFn)(void* user_data, const TF_TString* event_name,
...
static inline void TP_Events_SetPublishCallback(TP_Events* builder, TP_Events_PublishFn publish_cb) {

...
typedef void (*TP_ProfilerFns_CollectDataXspace)(
...
static inline void TP_ProfilerFns_SetCollectDataXspace(
    TP_ProfilerFns* builder, TP_ProfilerFns_CollectDataXspace collect_data_xspace
)
{

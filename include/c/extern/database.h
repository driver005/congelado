...
typedef void (*TP_Database_QueryFn)(void* user_data, const TF_TString* payload,
                                    TF_Database_CompletionFn completion, void* cb_user_data);
typedef void (*TP_Database_InsertFn)(void* user_data, const TF_TString* payload,
                                     TF_Database_CompletionFn completion, void* cb_user_data);
typedef void (*TP_Database_UpdateFn)(void* user_data, const TF_TString* payload,
                                     TF_Database_CompletionFn completion, void* cb_user_data);
typedef void (*TP_Database_RemoveFn)(void* user_data, const TF_TString* payload,
                                     TF_Database_CompletionFn completion, void* cb_user_data);
...
static inline void TP_Database_SetIsConnectedCallback(TP_Database* builder, TP_Database_IsConnectedFn is_connected_cb) {
  builder->is_connected_cb = is_connected_cb;
}

static inline void TP_Database_SetQueryCallback(TP_Database* builder, TP_Database_QueryFn query_cb) {
  builder->query_cb = query_cb;
}

static inline void TP_Database_SetInsertCallback(TP_Database* builder, TP_Database_InsertFn insert_cb) {
  builder->insert_cb = insert_cb;
}

static inline void TP_Database_SetUpdateCallback(TP_Database* builder, TP_Database_UpdateFn update_cb) {
  builder->update_cb = update_cb;
}

static inline void TP_Database_SetRemoveCallback(TP_Database* builder, TP_Database_RemoveFn remove_cb) {

...
#include <stdint.h>
#include <stdlib.h>
typedef struct TF_ShapeInferenceContext TF_ShapeInferenceContext;
...
extern "C"
{
    ...
    // registered.
    TF_CAPI_EXPORT extern TF_OpDefinitionBuilder* TF_NewOpDefinitionBuilder(const char* op_name);
    ...
    TF_RegisterOpDefinition(TF_OpDefinitionBuilder* builder, TF_Status* status);
    ...
    TF_CAPI_EXPORT extern void TF_DeleteOpDefinitionBuilder(TF_OpDefinitionBuilder* builder);
    ...
    TF_CAPI_EXPORT extern void
    TF_OpDefinitionBuilderAddAttr(TF_OpDefinitionBuilder* builder, const char* attr_spec);
    ...
    TF_CAPI_EXPORT extern void
    TF_OpDefinitionBuilderAddInput(TF_OpDefinitionBuilder* builder, const char* input_spec);
    ...
    //   <type-list> is the name of an attr with type "list(type)".
    TF_CAPI_EXPORT extern void
    TF_OpDefinitionBuilderAddOutput(TF_OpDefinitionBuilder* builder, const char* output_spec);

    // Sets the commutative property for the op built by the given builder.
    TF_CAPI_EXPORT extern void
    TF_OpDefinitionBuilderSetIsCommutative(TF_OpDefinitionBuilder* builder, bool is_commutative);
    ...
    TF_CAPI_EXPORT extern void
    TF_OpDefinitionBuilderSetIsAggregate(TF_OpDefinitionBuilder* builder, bool is_aggregate);
    ...
    TF_CAPI_EXPORT extern void
    TF_OpDefinitionBuilderSetIsStateful(TF_OpDefinitionBuilder* builder, bool is_stateful);
    ...
    typedef void (*TF_ShapeInferenceFn)(TF_ShapeInferenceContext* ctx, TF_Status* status);
    TF_CAPI_EXPORT extern void TF_OpDefinitionBuilderSetShapeInferenceFunction(
        TF_OpDefinitionBuilder* builder, TF_ShapeInferenceFn shape_inference_func
    );
    ...
    TF_CAPI_EXPORT extern int64_t TF_ShapeInferenceContextNumInputs(TF_ShapeInferenceContext* ctx);
    ...
    TF_CAPI_EXPORT extern void TF_ShapeInferenceContextGetInput(
        TF_ShapeInferenceContext* ctx, int i, TF_ShapeHandle* handle, TF_Status* status
    );
    ...
    // delete `handle`.
    TF_CAPI_EXPORT
    extern void TF_ShapeInferenceContextSetOutput(
        TF_ShapeInferenceContext* ctx, int i, TF_ShapeHandle* handle, TF_Status* status
    );

    // Returns a newly-allocated scalar shape handle. The returned handle should
    // be freed with TF_DeleteShapeHandle.
    TF_CAPI_EXPORT extern TF_ShapeHandle*
    TF_ShapeInferenceContextScalar(TF_ShapeInferenceContext* ctx);
    ...
    TF_CAPI_EXPORT extern TF_ShapeHandle*
    TF_ShapeInferenceContextVectorFromSize(TF_ShapeInferenceContext* ctx, size_t size);
    ...
    TF_CAPI_EXPORT extern void TF_ShapeInferenceContext_GetAttrType(
        TF_ShapeInferenceContext* ctx, const char* attr_name, TF_DataType* val, TF_Status* status
    );

    // Returns the rank of the shape represented by the given handle.
    TF_CAPI_EXPORT extern int64_t
    TF_ShapeInferenceContextRank(TF_ShapeInferenceContext* ctx, TF_ShapeHandle* handle);

    // Returns 1 if `handle` has a known rank, 0 otherwise.
    TF_CAPI_EXPORT extern int
    TF_ShapeInferenceContextRankKnown(TF_ShapeInferenceContext* ctx, TF_ShapeHandle* handle);
    ...
    TF_CAPI_EXPORT extern void
    TF_ShapeInferenceContextSetUnknownShape(TF_ShapeInferenceContext* ctx, TF_Status* status);

    // Returns whether the given handle represents a known dimension.
    TF_CAPI_EXPORT extern int TF_DimensionHandleValueKnown(TF_DimensionHandle* dim_handle);

    // Returns the value of the given dimension.
    TF_CAPI_EXPORT extern int64_t TF_DimensionHandleValue(TF_DimensionHandle* dim_handle);

...
extern "C"
{
    ...
    typedef void (*TP_Cache_GetFn)(
        void* user_data, const TF_TString* key, TF_Cache_CompletionFn completion, void* cb_user_data
    );
    typedef void (*TP_Cache_SetFn)(
        void* user_data,
    ...
    typedef void (*TP_Cache_RemoveFn)(
        void* user_data, const TF_TString* key, TF_Cache_CompletionFn completion, void* cb_user_data
    );

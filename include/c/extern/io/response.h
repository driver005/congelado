...
typedef void (*TP_IO_Response_SetStatusFn)(void* user_data,
    int32_t status_code);
typedef void (*TP_IO_Response_SetHeaderFn)(void* user_data,
    const TF_TString* name, const TF_TString* value);
typedef void (*TP_IO_Response_SetBodyFn)(void* user_data,
...
static inline void TP_IOResponse_SetSetStatusCallback(TP_IO_Response* builder, TP_IO_Response_SetStatusFn set_status_cb) {
  builder->set_status_cb = set_status_cb;
}

static inline void TP_IOResponse_SetSetHeaderCallback(TP_IO_Response* builder, TP_IO_Response_SetHeaderFn set_header_cb) {
  builder->set_header_cb = set_header_cb;
}

static inline void TP_IOResponse_SetSetBodyCallback(TP_IO_Response* builder, TP_IO_Response_SetBodyFn set_body_cb) {

...
typedef TP_IO_Request* (*TP_IO_CreateRequestFn)(void* user_data,
                                                TF_Status* status);
typedef TP_IO_Response* (*TP_IO_CreateResponseFn)(void* user_data,
                                                  TF_Status* status);
...
static inline void TP_IO_SetCreateRequestCallback(TP_IO* builder, TP_IO_CreateRequestFn create_request_cb) {
  builder->create_request_cb = create_request_cb;
}

static inline void TP_IO_SetCreateResponseCallback(TP_IO* builder, TP_IO_CreateResponseFn create_response_cb) {

...
extern "C"
{
    ...
    typedef struct TF_Env
    {
        ...
        // dynamic_library
        void* (*load_shared_library)(void* plugin_context, const TF_TString* library_filename, TF_Status* status);
        void* (*get_symbol_from_library)(void* plugin_context, void* handle, const TF_TString* symbol_name, TF_Status* status);


        // thread
        void (*default_thread_options)(void* plugin_context, TF_ThreadOptions* options);
        TF_Thread* (*start_thread)(void* plugin_context, const TF_ThreadOptions* options, const TF_TString* thread_name, TF_ThreadWorkFn work_func, void* param);
    ...
    TF_CAPI_EXPORT extern void TF_InitEnv(TF_Env** ops, void** plugin_context, TF_Status* status);

...
extern "C"
{
    ...
    typedef int64_t (*TP_RandomAccessFile_Read)(
    ...
    static inline void
    TF_RandomAccessFile_SetPluginFile(TF_RandomAccessFile* builder, void* plugin_file)
    {
    ...
    {
        TF_RandomAccessFileOps* ptr =
            (TF_RandomAccessFileOps*)malloc(sizeof(TF_RandomAccessFileOps));
        if (!ptr) {
            return nullptr;
        }
        ptr->cleanup = nullptr;
    ...
    static inline void TF_RandomAccessFileOps_SetCleanup(
        TF_RandomAccessFileOps* builder, TP_RandomAccessFile_Cleanup cleanup
    )
    {
    ...
    static inline void
    TF_RandomAccessFileOps_SetRead(TF_RandomAccessFileOps* builder, TP_RandomAccessFile_Read read)
    {
        builder->read = read;
    }

...
typedef struct TF_FilesystemPluginOps {
  ...
  TF_ReadOnlyMemoryRegionOps* read_only_memory_region_ops;  // ReadOnlyMemoryRegion operations table
...
static inline TF_FilesystemPluginOps* TF_FilesystemPluginOpsNew(void) {
  TF_FilesystemPluginOps* ptr = (TF_FilesystemPluginOps*)malloc(sizeof(TF_FilesystemPluginOps));
...
static inline void TF_FilesystemPluginOps_SetScheme(TF_FilesystemPluginOps* builder, char* scheme) {
  builder->scheme = scheme;
}

static inline void TF_FilesystemPluginOps_SetFilesystemOps(TF_FilesystemPluginOps* builder, TF_FilesystemOps* ops) {
...
static inline void TF_FilesystemPluginOps_SetRandomAccessFileOps(TF_FilesystemPluginOps* builder, TF_RandomAccessFileOps* ops) {
...
static inline void TF_FilesystemPluginOps_SetWritableFileOps(TF_FilesystemPluginOps* builder, TF_WritableFileOps* ops) {
...
static inline void TF_FilesystemPluginOps_SetReadOnlyMemoryRegionOps(TF_FilesystemPluginOps* builder, TF_ReadOnlyMemoryRegionOps* ops) {
...
static inline TF_FilesystemPluginInfo* TF_FilesystemPluginInfoNew(void) {
  TF_FilesystemPluginInfo* ptr = (TF_FilesystemPluginInfo*)malloc(sizeof(TF_FilesystemPluginInfo));
  if (!ptr) return nullptr;
  ptr->num_schemes = 0;
  ptr->ops = nullptr;
...
static inline void TF_FilesystemPluginInfo_SetNumSchemes(TF_FilesystemPluginInfo* builder, size_t num_schemes) {
  builder->num_schemes = num_schemes;
}

static inline void TF_FilesystemPluginInfo_SetOps(TF_FilesystemPluginInfo* builder, TF_FilesystemPluginOps* ops) {
    builder->ops = ops;
}

static inline void TF_FilesystemPluginInfo_SetMemoryAllocator(TF_FilesystemPluginInfo* builder,

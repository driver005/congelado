...
extern "C"
{
    ...
    typedef void (*TP_WritableFile_Append)(
        const TF_WritableFile* file, const char* buffer, size_t n, TF_Status* status
    );
    ...
    typedef int64_t (*TP_WritableFile_Tell)(const TF_WritableFile* file, TF_Status* status);
    ...
    typedef void (*TP_WritableFile_Flush)(const TF_WritableFile* file, TF_Status* status);
    ...
    ///
    /// DEFAULT IMPLEMENTATION: No op.
    typedef void (*TP_WritableFile_Sync)(const TF_WritableFile* file, TF_Status* status);
    ...
    typedef void (*TP_WritableFile_Close)(const TF_WritableFile* file, TF_Status* status);
    ...
    static inline void
    TF_WritableFileOps_SetCleanup(TF_WritableFileOps* builder, TP_WritableFile_Cleanup cleanup)
    {
        builder->cleanup = cleanup;
    }

    static inline void
    TF_WritableFileOps_SetAppend(TF_WritableFileOps* builder, TP_WritableFile_Append append)
    {
        builder->append = append;
    }

    static inline void
    TF_WritableFileOps_SetTell(TF_WritableFileOps* builder, TP_WritableFile_Tell tell)
    {
        builder->tell = tell;
    }

    static inline void
    TF_WritableFileOps_SetFlush(TF_WritableFileOps* builder, TP_WritableFile_Flush flush)
    {
        builder->flush = flush;
    }

    static inline void
    TF_WritableFileOps_SetSync(TF_WritableFileOps* builder, TP_WritableFile_Sync sync)
    {
        builder->sync = sync;
    }

    static inline void
    TF_WritableFileOps_SetClose(TF_WritableFileOps* builder, TP_WritableFile_Close close)
    {
        builder->close = close;
    }

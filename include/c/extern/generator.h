...
#ifndef TENSORFLOW_C_EXPERIMENTAL_GENERATOR_GENERATOR_H_
#define TENSORFLOW_C_EXPERIMENTAL_GENERATOR_GENERATOR_H_

// General-purpose code generator framework.

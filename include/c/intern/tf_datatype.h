...
extern "C"
{
    ...
    TF_CAPI_EXPORT extern size_t TF_DataTypeSize(TF_DataType_Enum dt);
    ...
    typedef struct TF_DataType
    {
        ...
        size_t (*TF_DataTypeSize)(void* ctx, TF_DataType_Enum dt);

    } TF_DataType;

#define TF_DATATYPE_STRUCT_SIZE TF_OFFSET_OF_END(TF_DataType, TF_DataTypeSize)

    TF_CAPI_EXPORT extern void TF_InitDataType(
        TF_DataType** ops, void** plugin_context, TF_Status* status
    );

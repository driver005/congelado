...
concept AsyncSocket =
    ...
    requires(
        ...
        unsigned nbytes,
        off_t offset,
        leverage::CompletionCallback callback,
    ...
    // requires(E &engine, const char *path, int flags, mode_t mode,
    // leverage::CompletionCallback callback, leverage::IFlags iflags) {

...
// Satisfies FlowLayer — constructible from (SendCallback, CloseCallback), on_read() ->
// ReadCallback.
class MockFlowLayer
{
public:
...
public:
    ...
    Scheduled create(std::string_view, WorkerFunction, ReleaseFunction, ErrorHandler)
    {
        return {};
    }
};
...
// Satisfies FlowBase — constructible from (ReadCallback&&, Leverager&, Controller),
// on_send(int) -> SendCallback.
class MockFlowBase
{
public:

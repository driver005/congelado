...
public:
     ...
     */
    void set_nullable(bool value) noexcept
    {
        m_nullable = value;
    }
     ...
     */
    void add_enum_value(std::string value)
    {
        m_enum_values.push_back(std::move(value));
    }
     ...
     */
    [[nodiscard]] const std::string& get_format() const noexcept
    {
        return m_format;
    }
     ...
     * otherwise).
     */
    [[nodiscard]] bool get_nullable() const noexcept
    {
        return m_nullable;
    }
     ...
     */
    [[nodiscard]] const std::string& get_ref() const noexcept
    {
        return m_ref;
    }
     ...
     */
    [[nodiscard]] const std::shared_ptr<SchemaObject>& get_items() const noexcept
    {
        return m_items;
    }
...
public:
     ...
     */
    void set_schema(SchemaObject schema)
    {
     ...
     */
    [[nodiscard]] const SchemaObject& get_schema() const noexcept
    {
        return m_schema;
    }
...
public:
     ...
     */
    [[nodiscard]] bool get_required() const noexcept
    {
        return m_required;
    }
...
public:
     ...
     */
    [[nodiscard]] const std::string& get_summary() const noexcept
    {
        return m_summary;
    }
     ...
     * @warning Comes back null if set_request_body() was never called — most GET operations
     * won't have a body, so check before dereferencing, don't just yolo it.
...
public:
     ...
     */
    void set_openapi(std::string value)
    {
        m_openapi = std::move(value);
    }
     ...
     */
    void set_components(Components components)
    {
     ...
     */
    [[nodiscard]] const std::string& get_openapi() const noexcept
    {
        return m_openapi;
    }
     ...
     */
    [[nodiscard]] const Info& get_info() const noexcept
    {
        return m_info;
    }
     ...
     */
    [[nodiscard]] const Components& get_components() const noexcept
    {
        return m_components;
    }
...
struct serde::Serializable<utils::openapi::RequestBody>
{
    ...
    static constexpr auto fields()
    {
        ...
        return std::tuple{
            serde::FieldDesc<"required", &RequestBody::get_required, &RequestBody::set_required>{},

export module utils_openapi:generator;
...
class Generator {
  public:
    ...
    [[nodiscard]] std::expected<void, std::string> write(const Document &document) const {
        return core::generator::Generator::write(m_output_path, serde::Json::encode(document));
    }
    ...
    [[nodiscard]] core::router::Route<> serve() const {
        ...
        return core::router::Route<>{m_serve_path}.get(
            [info](interfaces::io::IRequest & /*req*/, interfaces::io::IResponse &res) {
                ...
                auto bytes = serde::Ser::serialize_raw("application/json",
                                                       serde::Json::encode(generator.generate()));
  ...
  private:
    ...
    std::string m_serve_path{"/openapi.json"};
};

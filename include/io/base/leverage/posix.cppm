...
template <>
void Leverager<Context>::readv(int fd, const iovec *iovecs, unsigned nr_vecs, off_t offset, completion_callback cb,
                               std::uint8_t iflags) {
...
template <>
void Leverager<Context>::readv2(int fd, const iovec *iovecs, unsigned nr_vecs, off_t offset, int flags,
...
template <>
void Leverager<Context>::writev(int fd, const iovec *iovecs, unsigned nr_vecs, off_t offset, completion_callback cb,
                                std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::writev2(int fd, const iovec *iovecs, unsigned nr_vecs, off_t offset, int flags,
                                 completion_callback cb, std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::read(int fd, void *buf, unsigned nbytes, off_t offset, completion_callback cb,
                              std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::write(int fd, const void *buf, unsigned nbytes, off_t offset, completion_callback cb,
                               std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::read_fixed(int fd, void *buf, unsigned nbytes, off_t offset, int buf_index,
                                    completion_callback cb, std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::write_fixed(int fd, const void *buf, unsigned nbytes, off_t offset, int buf_index,
                                     completion_callback cb, std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::fsync(int fd, unsigned fsync_flags, completion_callback cb, std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::sync_file_range(int fd, off64_t offset, off64_t nbytes, unsigned sync_range_flags,
                                         completion_callback cb, std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::recvmsg(int sockfd, msghdr *msg, std::uint32_t flags, completion_callback cb,
                                 std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::sendmsg(int sockfd, const msghdr *msg, std::uint32_t flags, completion_callback cb,
                                 std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::recv(int sockfd, void *buf, unsigned nbytes, std::uint32_t flags, completion_callback cb,
                              std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::send(int sockfd, const void *buf, unsigned nbytes, std::uint32_t flags, completion_callback cb,
                              std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::poll(int fd, short poll_mask, completion_callback cb, std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::yield(completion_callback cb, std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::accept(int fd, sockaddr *addr, socklen_t *addrlen, int flags, completion_callback cb,
                                std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::connect(int fd, sockaddr *addr, socklen_t addrlen, completion_callback cb,
                                 std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::timeout(__kernel_timespec *ts, completion_callback cb, std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::openat(int dfd, const char *path, int flags, mode_t mode, completion_callback cb,
                                std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::close(int fd, completion_callback cb, std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::tee(int fd_in, int fd_out, std::size_t nbytes, unsigned flags, completion_callback cb,
                             std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::shutdown(int fd, int how, completion_callback cb, std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::mkdirat(int dirfd, const char *pathname, mode_t mode, completion_callback cb,
                                 std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::symlinkat(const char *target, int newdirfd, const char *linkpath, completion_callback cb,
                                   std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::unlinkat(int dfd, const char *path, unsigned flags, completion_callback cb,
                                  std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();
...
template <>
void Leverager<Context>::msg_ring(int fd, unsigned len, std::uint64_t data, unsigned flags, completion_callback cb,
                                  std::uint8_t iflags) {
    auto *sqe = m_context.get_sqe_safe();

// Build-time code generator: emits ONLY table.cppm — the one piece of yoshi_omah_lay_stable_hlo that
...
std::vector<std::string> render_table_file(const std::vector<JsonOpDefinition> &ops) {
    ...
    push_block(R"GENCODE(// GENERATED FILE — produced at build time by include/yoshi/omah_lay/stable_hlo/build.cc, do not hand-edit.

...
//
// Implements ice::builder::TypeInfo directly — the one type-info class for all of
...
// Shape's ice::builder::Attribute instead).
class DType : public ice::builder::TypeInfo
{
public:

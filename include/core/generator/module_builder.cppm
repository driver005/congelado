...
public:
    ...
    // build.
    Class& addClass(std::string name)
     ...
     */
    Function& addFunction(std::string returnType, std::string name)
    { // NOLINT(readability-identifier-naming) — matches this project's get/set/add accessor
      // naming convention (camelCase after prefix), not a real naming defect — the shared
      // clang-tidy config has no accessor exception
...
public:
     ...
     */
    Module& addImport(std::string name)
    { // NOLINT(readability-identifier-naming) — matches this project's get/set/add accessor
      // naming convention (camelCase after prefix), not a real naming defect — the shared
      // clang-tidy config has no accessor exception
     ...
     * @return reference to this module for chaining.
     */
    Module& addRawBlock(std::string block)
    { // NOLINT(readability-identifier-naming) — matches this project's get/set/add accessor
      // naming convention (camelCase after prefix), not a real naming defect — the shared
      // clang-tidy config has no accessor exception

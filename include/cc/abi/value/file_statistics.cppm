...
class FileStatistics {
  public:
    ...
    int64_t get_length() const { return m_stats.length; }
    void set_length(int64_t length) { m_stats.length = length; }

    int64_t get_mtime_nsec() const { return m_stats.mtime_nsec; }
    void set_mtime_nsec(int64_t t) { m_stats.mtime_nsec = t; }

    bool get_is_directory() const { return m_stats.is_directory != 0; }
    void set_is_directory(bool d) { m_stats.is_directory = d ? 1 : 0; }
    ...
    TF_FileStatistics *get_handle() { return &m_stats; }
    const TF_FileStatistics *get_handle() const { return &m_stats; }

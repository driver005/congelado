...
public:
    ...
    [[nodiscard]] std::expected<void, ice::Status> get_bind_port(uint16_t* out_port) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status>
    ...
    [[nodiscard]] std::expected<void, ice::Status> is_running(int* out_running) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> is_idle(int* out_idle) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status>

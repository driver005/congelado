...
public:
    ...
    [[nodiscard]] std::expected<void, ice::Status> set_header(
        const ice::sonic::TF_StringOps& name,
        const ice::sonic::TF_StringOps& value
    ) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> add_header(
        const ice::sonic::TF_StringOps& name,
        const ice::sonic::TF_StringOps& value
    ) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status>
    ...
    [[nodiscard]] std::expected<void, ice::Status> is_keep_alive(int* out_keep_alive) noexcept = 0;
    ...
    [[nodiscard]] std::expected<void, ice::Status> is_informational(int* out_result) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> is_success(int* out_result) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> is_redirection(int* out_result) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> is_client_error(int* out_result) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> is_server_error(int* out_result) noexcept = 0;

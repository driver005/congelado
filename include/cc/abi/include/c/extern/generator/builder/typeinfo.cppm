...
public:
    ...
    [[nodiscard]] std::expected<void, ice::Status> set_data_type(int data_type) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> set_read_only(_Bool read_only) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> set_list(_Bool is_list) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status>
    get_type_attr_name(const ice::sonic::TF_StringOps& out_type_attr_name) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> get_data_type(int* out_data_type) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> is_read_only(int* out_is_read_only) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> is_list(int* out_is_list) noexcept = 0;

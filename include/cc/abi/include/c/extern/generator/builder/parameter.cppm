...
public:
    ...
    [[nodiscard]] std::expected<void, ice::Status> set_position(int position) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status>
    get_description(const ice::sonic::TF_StringOps& out_description) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> get_position(int* out_position) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status>

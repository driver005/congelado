...
public:
    ...
    [[nodiscard]] std::expected<void, ice::Status> tell(int64_t* out_position) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> flush() noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> sync() noexcept = 0;

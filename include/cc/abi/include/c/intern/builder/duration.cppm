...
public:
    ...
    [[nodiscard]] std::expected<void, ice::Status> get_ticks(int64_t* out_ticks) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> get_ratio_num(int64_t* out_num) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> get_ratio_den(int64_t* out_den) noexcept = 0;

...
public:
    ...
    [[nodiscard]] std::expected<void, ice::Status> get_type(TFTStringType* out_type) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> get_size(size_t* out_size) noexcept = 0;
    [[nodiscard]] std::expected<void, ice::Status> get_capacity(size_t* out_capacity) noexcept = 0;

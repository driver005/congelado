...
export module cc_abi_runtime_otel:counter;

export namespace ice {

// Non-owning wrapper around a `TP_Otel_Counter*` (e.g. returned by MeterRuntime::invoke_create_counter).
class CounterRuntime {
 public:
  CounterRuntime() : m_handle{nullptr} {}
  ...
  TP_Otel_Counter *get_handle() const { return m_handle; }

...
export module cc_abi_runtime:python;
...
class PythonApiRuntime {
 public:
  ...
  static void set_attr(TF_Graph* graph, TF_Operation* op, const ice::StringRuntime& attr_name,
                      TF_Buffer* attr_value_proto, TF_Status* status) {
    tensorflow::SetAttr(graph, op, attr_name.c_str(), attr_value_proto, status);
  }

  static void clear_attr(TF_Graph* graph, TF_Operation* op, const ice::StringRuntime& attr_name,
                        TF_Status* status) {
  ...
  static void set_requested_device(TF_Graph* graph, TF_Operation* op, const ice::StringRuntime& device) {

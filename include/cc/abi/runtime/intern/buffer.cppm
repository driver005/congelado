...
export module cc_abi_runtime_intern:buffer;
...
class BufferRuntime {
  public:
    BufferRuntime() : m_buffer{nullptr} {}
    explicit BufferRuntime(const TF_Buffer *buffer) : m_buffer{buffer} {}

    bool is_valid() const { return m_buffer != nullptr; }
    const void *get_data() const { return m_buffer ? m_buffer->data : nullptr; }

...
export module cc_abi_runtime:profiler;
...
class ProfilerFnsRuntime {
 public:
  ProfilerFnsRuntime() : m_handle{nullptr} {}
  explicit ProfilerFnsRuntime(TP_ProfilerFns* handle) : m_handle{handle} {}
  ...
  void invoke_collect_data_xspace(const TP_Profiler* profiler, uint8_t* buffer, size_t* size_in_bytes,
  ...
  TP_ProfilerFns *get_handle() const { return m_handle; }

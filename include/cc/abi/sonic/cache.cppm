...
export module cc_abi_sonic:cache;
...
public:
    ...
    explicit CacheRuntime(TP_Cache* handle) :
        m_handle{handle}
    {
    }

    void invoke_get(
        const TF_TString* key, TF_Cache_CompletionFn completion, void* cb_user_data
    ) const
    {

...
export module cc_abi_sonic:payload;
...
public:
    ...
    explicit PayloadRuntime(TP_Payload* handle) :
        m_handle{handle}
    {
    }
    ...
    void invoke_read(
        const TF_TString* reference, TF_Payload_CompletionFn completion, void* cb_user_data
    ) const
    {

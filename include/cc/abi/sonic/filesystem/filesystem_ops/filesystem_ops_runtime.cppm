...
export module cc_abi_sonic_filesystem:filesystem_ops_runtime;
...
{
public:
    FilesystemOpsRuntime() :
        m_handle{nullptr}
    {
    }

    explicit FilesystemOpsRuntime(TF_FilesystemOps* handle) :
        m_handle{handle}
    {
    }

    // Underlying handle — pass directly to the C ABI
    TF_FilesystemOps* get_handle() const
    {
        return m_handle;
    }

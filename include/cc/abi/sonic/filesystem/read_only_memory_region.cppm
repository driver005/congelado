...
export module cc_abi_sonic_filesystem:read_only_memory_region;
...
{
public:
    ReadOnlyMemoryRegionOpsRuntime() :
        m_handle{nullptr}
    {
    }

    explicit ReadOnlyMemoryRegionOpsRuntime(TF_ReadOnlyMemoryRegionOps* handle) :
        m_handle{handle}
    {
    }
    ...
    TF_ReadOnlyMemoryRegionOps* get_handle() const
    {
        return m_handle;
    }

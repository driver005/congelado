...
export module cc_abi_sonic_filesystem:writable_file_ops_runtime;
...
{
public:
    WritableFileOpsRuntime() :
        m_handle{nullptr}
    {
    }

    explicit WritableFileOpsRuntime(TF_WritableFileOps* handle) :
        m_handle{handle}
    {
    }
    ...
    TF_WritableFileOps* get_handle() const
    {
        return m_handle;
    }

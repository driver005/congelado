...
export module cc_abi_sonic_otel:span;

import cc_abi_sonic_intern;

export namespace ice::sonic {

// Non-owning wrapper around a `TP_Otel_Span*` (e.g. returned by
// TracerRuntime::invoke_start_span).
class SpanRuntime
{
public:
    SpanRuntime() :
    ...
    explicit SpanRuntime(TP_Otel_Span* handle) :
        m_handle{handle}
    {
    }

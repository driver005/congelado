...
class OrchestratorBuilder {
 public:
  OrchestratorBuilder() : m_handle{TP_OrchestratorNew()} {}
  ~OrchestratorBuilder() { TP_OrchestratorDelete(m_handle); }

  OrchestratorBuilder(const OrchestratorBuilder&) = delete;
  OrchestratorBuilder& operator=(const OrchestratorBuilder&) = delete;

  OrchestratorBuilder(OrchestratorBuilder&& other) noexcept : m_handle{other.m_handle} { other.m_handle = nullptr; }
  ...
  TP_Orchestrator *get_handle() { return m_handle; }
  const TP_Orchestrator *get_handle() const { return m_handle; }

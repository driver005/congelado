...
public:
    ...
    virtual [[nodiscard]] std::expected<void, ice::Status> index(
    ...
    virtual [[nodiscard]] std::expected<void, ice::Status> remove(
        const ice::String& collection,
        const ice::String& id,
        TF_Search_CompletionFn completion,
        void* cb_user_data
    ...
    virtual [[nodiscard]] std::expected<void, ice::Status> search(
        const ice::String& collection,

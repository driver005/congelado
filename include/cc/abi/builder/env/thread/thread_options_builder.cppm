...
public:
    ...
    ThreadOptionsBuilder(ThreadOptionsBuilder&& other) noexcept :
    ...
    TF_ThreadOptions* get_handle()
    {
        return m_handle;
    }

    const TF_ThreadOptions* get_handle() const
    {
        return m_handle;
    }

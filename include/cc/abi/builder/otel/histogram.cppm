...
class HistogramBuilder {
 public:
  HistogramBuilder() : m_handle{TP_OtelHistogramNew()} {}
  ~HistogramBuilder() { TP_OtelHistogramDelete(m_handle); }
  ...
  TP_Otel_Histogram *get_handle() { return m_handle; }
  const TP_Otel_Histogram *get_handle() const { return m_handle; }

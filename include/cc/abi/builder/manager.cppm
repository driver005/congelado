...
class WorkerManagerBuilder {
 public:
  WorkerManagerBuilder() : m_handle{TP_WorkerManagerNew()} {}
  ~WorkerManagerBuilder() { TP_WorkerManagerDelete(m_handle); }

  WorkerManagerBuilder(const WorkerManagerBuilder&) = delete;
  WorkerManagerBuilder& operator=(const WorkerManagerBuilder&) = delete;

  WorkerManagerBuilder(WorkerManagerBuilder&& other) noexcept : m_handle{other.m_handle} { other.m_handle = nullptr; }
  ...
  TP_WorkerManager *get_handle() { return m_handle; }
  const TP_WorkerManager *get_handle() const { return m_handle; }

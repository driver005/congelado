...
class WorkerBuilder {
 public:
  WorkerBuilder() : m_handle{TP_WorkerNew()} {}
  ~WorkerBuilder() { TP_WorkerDelete(m_handle); }
  ...
  TP_Worker *get_handle() { return m_handle; }
  const TP_Worker *get_handle() const { return m_handle; }

...
class CacheBuilder {
 public:
  CacheBuilder() : m_handle{TP_CacheNew()} {}
  ~CacheBuilder() { TP_CacheDelete(m_handle); }
  ...
  TP_Cache *get_handle() { return m_handle; }
  const TP_Cache *get_handle() const { return m_handle; }

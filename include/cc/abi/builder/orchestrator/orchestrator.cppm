...
{
public:
    // Recover the Orchestrator instance from the opaque void* context slot that every
    ...
    static Orchestrator* create(void* ctx) noexcept
    {
        return static_cast<Orchestrator*>(ctx);
    }

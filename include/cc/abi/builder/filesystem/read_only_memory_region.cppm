...
{
public:
    ReadOnlyMemoryRegionOpsBuilder() :
        m_handle{TF_ReadOnlyMemoryRegionOpsNew()}
    {
    }
    ...
    ReadOnlyMemoryRegionOpsBuilder(ReadOnlyMemoryRegionOpsBuilder&& other) noexcept :
    ...
    TF_ReadOnlyMemoryRegionOps* get_handle()
    {
        return m_handle;
    }

    const TF_ReadOnlyMemoryRegionOps* get_handle() const
    {
        return m_handle;
    }

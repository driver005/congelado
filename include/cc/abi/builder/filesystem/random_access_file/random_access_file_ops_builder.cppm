...
{
public:
    RandomAccessFileOpsBuilder() :
        m_handle{TF_RandomAccessFileOpsNew()}
    {
    }
    ...
    RandomAccessFileOpsBuilder(RandomAccessFileOpsBuilder&& other) noexcept :
    ...
    TF_RandomAccessFileOps* get_handle()
    {
        return m_handle;
    }

    const TF_RandomAccessFileOps* get_handle() const
    {
        return m_handle;
    }

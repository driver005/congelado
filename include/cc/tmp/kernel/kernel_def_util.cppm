...
export module cc_tmp:kernel_kernel_def_util;
...
export {
    ...
    namespace tensorflow {
        ...
        absl::Status KernelAttrsMatch(const KernelDef& kernel_def, AttrSlice attrs, bool* match);

    } // namespace tensorflow

    // ==================================================================
    // Implementation: kernel_def_util.cc
    // ==================================================================
...
#undef RETURN_IF_ATTR_NOT_FOUND
                ...
                if (attr_value->type() != DT_INVALID) {
                    ...
                    for (int t: attr_value->list().type()) {
                        if (!InTypeList(static_cast<DataType>(t), constraint.allowed_values())) {
                            return absl::OkStatus();
                        }
                    }
                }

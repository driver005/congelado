...
export module cc_tmp:runtime_stats_aggregator;
    ...
    namespace tensorflow {
        ...
        namespace data {
            ...
            public:
                ...
                virtual void
                AddScalar(const std::string& name, float value, int64_t global_step) = 0;
                ...
                virtual absl::Status SetSummaryWriter(SummaryWriterInterface* summary_writer) = 0;

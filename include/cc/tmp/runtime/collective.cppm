...
export module cc_tmp:runtime_collective;
...
export {
    ...
    namespace tensorflow {
        ...
        struct CollImplDetails
        {
            ...
            std::vector<int32_t> dependencies;   // collective instances on which this node depends
        ...
        public:
            ...
            virtual absl::Status
            GetDeviceAttributes(const std::string& device, DeviceAttributes* attributes) = 0;
            ...
            virtual absl::Status
            UpdateDeviceAttributes(const std::vector<DeviceAttributes>& attributes) = 0;
        };
        ...
        public:
            ...
            virtual void CompleteParamsAsync(
            ...
            virtual void CompleteGroupAsync(
                const DeviceAttributes& device,
            ...
            // progress.
            virtual void CompleteInstanceAsync(
            ...
            // found.
            virtual absl::Status LookupGroup(int32_t group_key, CollGroupParams* group) = 0;
        ...
        public:
            ...
            virtual void GetStepSequenceAsync(
            ...
            virtual void
            RefreshStepIdSequenceAsync(int64_t graph_key, const StatusCallback& done) = 0;
        ...
        public:
            ...
            {
            public:
                explicit Handle(CollectiveExecutor* ce, bool inherit_ref) :
                    ce_(ce)
                {
                    if (!inherit_ref) {
                        ce->Ref();
        ...
        public:
            ...
            virtual void
            Enqueue(std::shared_ptr<CollectiveContext> col_ctx, StatusCallback done) = 0;
        ...
        public:
            ...
            virtual absl::Status InitializeCollectiveParams(CollectiveParams* col_params) = 0;
            ...
            // object.
            virtual absl::Status
            InitializeCollectiveContext(std::shared_ptr<CollectiveContext> col_ctx) = 0;
        ...
        public:
            ...
            static void GetAll(std::vector<CollectiveImplementationInterface*>* implementations);
        ...
        private:
            ...
            static absl::Status Register(const std::string& collective_name, Factory factory);
...
#define REGISTER_COLLECTIVE(name, implementation)                                                  \
    ...
    namespace tensorflow {
        ...
        namespace {
            ...
            {
                static std::vector<RegistrationInfo>* registry = new std::vector<RegistrationInfo>;
                return registry;
            }
        } // namespace
        ...
        CollInstanceParams& CollInstanceParams::operator=(const CollInstanceParams& other)
        {
            if (this != &other) {
        ...
        /*static*/ OpKernelContext::Params* CollectiveExecutor::CtxParams(OpKernelContext* ctx)
        {
            return ctx->params_;
        }
        ...
        CollectiveContext::CollectiveContext(
            ...
            output(output),
            device(nullptr),
            device_name(col_params->group.members[col_params->default_rank].device.name())
        {
        }
        ...
        /*static*/
        absl::Status
        CollectiveRegistry::Register(const std::string& collective_name, Factory factory)
        {
            std::vector<RegistrationInfo>* registry = MutableCollectiveRegistry();
            for (const RegistrationInfo& reg_info: *registry) {

...
export module cc_tmp:resource_session_state;
...
export {
    ...
    namespace tensorflow {
        ...
        public:
            ...
            absl::Status
            SaveTensors(const std::vector<std::string>& output_names, SessionState* session_state);

            // Returns true if no tensors have been added to this store.
            bool empty() TF_NO_THREAD_SAFETY_ANALYSIS
            {
                return !dirty_;
            }

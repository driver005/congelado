...
export module cc_tmp:utils_full_type_util;
...
export {
    ...
    namespace tensorflow {
        ...
        namespace full_type {
            ...
            absl::Status
            SpecializeType(const AttrSlice& attrs, const OpDef& op_def, FullTypeDef& target);
            ...
            bool IsSubtype(const FullTypeDef& lhs, const FullTypeDef& rhs, bool covariant = true);
    ...
    // ==================================================================
    // Implementation: full_type_util.cc
    // ==================================================================

...
export {
    ...
    namespace tensorflow {
        ...
        namespace full_type {
            ...
            // supertype.
            TypeInferenceFn
            UnaryContainerAdd(FullTypeId t, int container_idx, int element_idx, bool homogeneous);
            ...
            TypeInferenceFn
            MultiaryUnstack(FullTypeId t, std::function<FullTypeDef(const FullTypeDef&)> unstack);
    ...
    namespace tensorflow {
        ...
        namespace full_type {
            ...
            FullTypeDef UnstackTensor(const FullTypeDef& t)
            {
                ...
                DCHECK(
                    (t.type_id() == TFT_TENSOR) || (t.type_id() == TFT_RAGGED) ||
                    (t.type_id() == TFT_UNSET)
                );
                ...
                return [func_list](
                    ...
                    for (const auto& func: func_list) {
                        ...
                        TF_RETURN_WITH_CONTEXT_IF_ERROR(
                            status_or_t.status(),
                            absl::StrCat("for Tuple type infernce function ", ret_type.args_size())
                        );

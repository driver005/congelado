...
export module cc_tmp:variant_variant_encode_decode;
...
export {
    ...
    namespace tensorflow {
        ...
        template<
            ...
            bool = std::is_same<typename std::decay<T>::type, ::tensorflow::Tensor>::value,
            bool = std::is_base_of<protobuf::MessageLite, typename std::decay<T>::type>::value>
        struct TypeResolver
        {};
        ...
        void EncodeVariantImpl(
            const T& value,
            TypeResolver<T, false /* is_pod */, false /* Tensor */, true /* protobuf */>,
            VariantTensorData* data
        )
        {
        ...
        template<typename T>
        typename std::enable_if<!std::is_pointer<typename std::decay<T>::type>::value>::type
        EncodeVariantImpl(
            const T& value,
            TypeResolver<T, false /* is_pod */, false /* Tensor */, false /* protobuf */>,
            VariantTensorData* data
        )
        {
            value.Encode(data);
        ...
        // Specialization for POD type
        template<typename T>
        bool DecodeVariantImpl(
            VariantTensorData data,
            TypeResolver<T, true /* is_pod */, false /* Tensor */, false /* protobuf */>,
            T* value
        )
        {
        ...
        bool DecodeVariantImpl(
            VariantTensorData data,
            TypeResolver<T, false /* is_pod */, true /* Tensor */, false /* protobuf */>,
            T* value
        )
        {
            if (data.tensors_size() == 0) {
                return false;
            }
        ...
        struct has_type_name<
            ...
            typename std::enable_if<
                std::is_same<decltype(std::declval<C>().TypeName()), std::string>::value>::type> :
            std::true_type
        {};

        template<
            typename T,
            bool = has_type_name<typename std::decay<T>::type>::value,
            bool = std::is_same<typename std::decay<T>::type, ::tensorflow::Tensor>::value,
            bool = std::is_base_of<protobuf::MessageLite, typename std::decay<T>::type>::value>
        ...
        template<typename T>
        std::string
        TypeNameVariantImpl(const T& value, TypeNameResolver<T, true /* has_type_name */>)
        {
        ...
        std::string TypeNameVariantImpl(
            const T& value,
            TypeNameResolver<T, false /* has_type_name */, false /* Tensor */, true /* protobuf */>
        )
        {
        ...
        std::string TypeNameVariantImpl(
            const T& value,
            TypeNameResolver<T, false /* has_type_name */, false /* Tensor */, false /* protobuf */>
        )
        {
        ...
        struct has_debug_string<
            C,
            typename std::enable_if<
                std::is_same<decltype(std::declval<C>().DebugString()), std::string>::value>::
                type> : std::true_type
        {};
        ...
        struct can_strcat<
            C,
            typename std::enable_if<
                std::is_same<decltype(strings::StrCat(std::declval<C>())), std::string>::value>::
                type> : std::true_type
        {};
        ...
        template<typename T>
        std::string
        DebugStringVariantImpl(const T& value, DebugStringResolver<T, true /* has_debug_string */>)
        {
        ...
        std::string DebugStringVariantImpl(
            const T& value,
            DebugStringResolver<T, false /* has_debug_string */, true /* can_strcat */>
        )
        {
        ...
        std::string DebugStringVariantImpl(
            const T& value,
            DebugStringResolver<T, false /* has_debug_string */, false /* can_strcat */>
        )
        {
            return "?";
        }

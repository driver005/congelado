...
export {
    ...
    namespace tensorflow {
        ...
        namespace lookup {
            ...
            public:
                ...
                virtual absl::Status
                Insert(OpKernelContext* ctx, const Tensor& keys, const Tensor& values) = 0;
                ...
                // Insert function.
                virtual absl::Status
                ImportValues(OpKernelContext* ctx, const Tensor& keys, const Tensor& values) = 0;
                ...
                //   value shape.
                virtual absl::Status
                CheckKeyAndValueTensorsForInsert(const Tensor& keys, const Tensor& values);

                // Similar to the function above but instead checks eligibility for the Import
                // function.
                virtual absl::Status
                CheckKeyAndValueTensorsForImport(const Tensor& keys, const Tensor& values);
                ...
                absl::Status CheckFindArguments(const Tensor& keys, const Tensor& default_value);
            ...
            private:
                absl::Status
                CheckKeyAndValueTensorsHelper(const Tensor& keys, const Tensor& values);
            };
    ...
    namespace tensorflow {
        namespace lookup {
            ...
            Status LookupInterface::CheckKeyAndValueTypes(const Tensor& keys, const Tensor& values)
            {
            ...
            Status
            LookupInterface::CheckKeyAndValueTensorsHelper(const Tensor& keys, const Tensor& values)
            {
            ...
            Status
            LookupInterface::CheckFindArguments(const Tensor& key, const Tensor& default_value)
            {

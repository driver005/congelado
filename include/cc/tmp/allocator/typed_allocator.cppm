...
export module cc_tmp:allocator_typed_allocator;
...
export {
    ...
    namespace tensorflow {
        ...
        template<>
        /* static */
        inline void TypedAllocator::RunCtor(Allocator* raw_allocator, tstring* p, size_t n)
        {
        ...
        template<>
        /* static */
        inline void TypedAllocator::RunDtor(Allocator* raw_allocator, tstring* p, size_t n)
        {
            if (!raw_allocator->AllocatesOpaqueHandle()) {
                for (size_t i = 0; i < n; ++p, ++i) {
                    p->~tstring();
        ...
        template<>
        /* static */
        inline void TypedAllocator::RunCtor(Allocator* raw_allocator, ResourceHandle* p, size_t n)
        {
            if (!raw_allocator->AllocatesOpaqueHandle()) {
                for (size_t i = 0; i < n; ++p, ++i) {
        ...
        template<>
        /* static */
        inline void TypedAllocator::RunDtor(Allocator* raw_allocator, ResourceHandle* p, size_t n)
        {
            if (!raw_allocator->AllocatesOpaqueHandle()) {
                for (size_t i = 0; i < n; ++p, ++i) {
                    p->~ResourceHandle();
        ...
        template<>
        /* static */
        inline void TypedAllocator::RunCtor(Allocator* raw_allocator, Variant* p, size_t n)
        {
            if (!raw_allocator->AllocatesOpaqueHandle()) {
                RunVariantCtor(p, n);
            }
        ...
        template<>
        /* static */
        inline void TypedAllocator::RunDtor(Allocator* raw_allocator, Variant* p, size_t n)
        {
            if (!raw_allocator->AllocatesOpaqueHandle()) {
                RunVariantDtor(p, n);
            }
    ...
    // ==================================================================
    // Implementation: typed_allocator.cc
    // ==================================================================

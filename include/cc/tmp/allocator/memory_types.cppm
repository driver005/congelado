...
export module cc_tmp:allocator_memory_types;
...
export {
    ...
    namespace tensorflow {
        ...
        absl::Status MemoryTypesForNode(
    ...
    // ==================================================================
    // Implementation: memory_types.cc
    // ==================================================================
    ...
    namespace tensorflow {
        ...
        namespace {
            ...
            void MemoryTypesHelper(
                const NameRangeMap& name_map,
        ...
        {
            return (dtype == DT_INT32 || DataTypeAlwaysOnHost(dtype)) ? HOST_MEMORY : DEVICE_MEMORY;
        }
        ...
        )
        {
            ...
            absl::Status status =
                FindKernelDef(device_type, ndef, &kdef, nullptr /* kernel_class_name */, registry);
            ...
            if (has_kernel_def) {
                ...
                std::vector<std::string> host_memory_args(from_proto.begin(), from_proto.end());

...
export module cc_tmp:tensor_tensor_types;
...
export {
    ...
    namespace tensorflow {
        ...
        struct TTypes
        {
            ...
            typedef Eigen::
                TensorMap<Eigen::Tensor<T, NDIMS, Eigen::RowMajor, IndexType>, Eigen::Aligned>
                    Tensor;
            typedef Eigen::
                TensorMap<Eigen::Tensor<const T, NDIMS, Eigen::RowMajor, IndexType>, Eigen::Aligned>
                    ConstTensor;
            ...
            typedef Eigen::
                TensorMap<Eigen::Tensor<T, 1, Eigen::RowMajor, IndexType>, Eigen::Aligned>
                    Flat;
            typedef Eigen::
                TensorMap<Eigen::Tensor<const T, 1, Eigen::RowMajor, IndexType>, Eigen::Aligned>
                    ConstFlat;
            typedef Eigen::
                TensorMap<Eigen::Tensor<T, 1, Eigen::RowMajor, IndexType>, Eigen::Aligned>
                    Vec;
            ...
            typedef Eigen::
                TensorMap<Eigen::Tensor<T, 2, Eigen::RowMajor, IndexType>, Eigen::Aligned>
                    Matrix;
            typedef Eigen::
                TensorMap<Eigen::Tensor<const T, 2, Eigen::RowMajor, IndexType>, Eigen::Aligned>
                    ConstMatrix;
        ...
        bool SafeFor32BitIndexing(const Eigen::DSizes<Index, NumDims>& in)
        {
            for (int i = 0; i < NumDims; ++i) {
                if (in[i] > std::numeric_limits<Index32>::max()) {
                    return false;
                }
            }
            return true;
        ...
        template<typename Index, int NumDims>
        Eigen::DSizes<Index32, NumDims> To32Bit(const Eigen::DSizes<Index, NumDims>& in)
        {

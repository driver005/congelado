...
export module cc_tmp:dataset_dataset_stateful_op_allowlist;
    ...
    namespace tensorflow {
        namespace data {
            ...
            public:
                ...
                bool Contains(const std::string& op_name)
                {
            ...
            private:
                ...
                AllowlistedStatefulOpRegistry(const AllowlistedStatefulOpRegistry& copy) = delete;
                AllowlistedStatefulOpRegistry
                operator=(const AllowlistedStatefulOpRegistry& copy) = delete;

...
export module cc_tmp:shape_common_shape_fns;
...
export {
    ...
    namespace tensorflow {
        ...
        namespace shape_inference {
            ...
            inline absl::Status
            UnchangedShapeWithRank(shape_inference::InferenceContext* c, int32_t rank)
            {
                ShapeHandle out;
            ...
            inline absl::Status
            UnchangedShapeWithRankAtLeast(shape_inference::InferenceContext* c, int32_t rank)
            {
                ShapeHandle out;
            ...
            // Transfers shape of input(0) to output(0), after asserting its rank <= <rank>.
            inline absl::Status
            UnchangedShapeWithRankAtMost(shape_inference::InferenceContext* c, int32_t rank)
            {
                ShapeHandle out;
            ...
            absl::Status Conv2DShapeWithExplicitPadding(shape_inference::InferenceContext* c);
            ...
            // padding.
            absl::Status
            DepthwiseConv2DNativeShapeWithExplicitPadding(shape_inference::InferenceContext* c);
            ...
            absl::Status Conv2DBackpropFilterWithBiasShape(shape_inference::InferenceContext* c);
            ...
            absl::Status MaxPoolShapeWithExplicitPadding(shape_inference::InferenceContext* c);
            ...
            absl::Status
            ConcatShape(shape_inference::InferenceContext* c, int num_inputs_to_concat);
            ...
            absl::Status BroadcastBinaryOpOutputShapeFnHelper(
                InferenceContext* c,
                ShapeHandle shape_x,
                ShapeHandle shape_y,
            ...
            // and with output to output_index.
            inline absl::Status
            BroadcastBinaryOpOutputShapeFn(InferenceContext* c, int output_index)
            {
                ShapeHandle out;
                TF_RETURN_IF_ERROR(
                    BroadcastBinaryOpOutputShapeFnHelper(c, c->input(0), c->input(1), true, &out)
                );
            ...
            absl::Status ValidateSparseTensor(
                InferenceContext* c,
            ...
            absl::Status ScatterNdShapeHelper(
                InferenceContext* c,
                ShapeHandle indices_shape,
    ...
    // ==================================================================
    // Implementation: common_shape_fns.cc
    // ==================================================================
    ...
    namespace tensorflow {
        ...
        namespace shape_inference {
            ...
            absl::Status GetWindowedOutputSizeFromDimsV2(
                ...
                shape_inference::DimensionOrConstant filter_size,
                int64_t dilation_rate,
                int64_t stride,
                Padding padding_type,
                int64_t padding_before,
            ...
            namespace {
                ...
                absl::Status
                ValidateEinsumEllipsis(absl::string_view subscript, bool* found_ellipsis)
                {
            ...
            absl::Status EinsumShape(shape_inference::InferenceContext* c)
            {
                ...
                TF_RETURN_IF_ERROR(ValidateEinsumEquation(equation, &input_labels, &output_labels));

                if (c->num_inputs() == 0 || c->num_inputs() > 2) {
                    return absl::InvalidArgumentError(
                        absl::StrCat("Expected either 1 or 2 inputs but got: ", c->num_inputs())
                    );
                }
                ...
                for (int i = 0, end = c->num_inputs(); i < end; ++i) {
                    ...
                    for (int label_idx = 0, end = input_labels[i].size(); label_idx < end;
                        ...
                        DimensionHandle new_dim =
                            c->RankKnown(input_shape) ? c->Dim(input_shape, axis) : c->UnknownDim();
            ...
            )
            {
                if (tensor_format == FORMAT_NCHW_VECT_C) {
                    ...
                    if (vect_dim_val != 4 && vect_dim_val != 32) {
                        return absl::InvalidArgumentError(
                            absl::StrCat("VECT_C dimension must be 4 or 32, but is ", vect_dim_val)
                        );
                    }
                }
            ...
            absl::Status DatasetIteratorShape(shape_inference::InferenceContext* c)
            {
                ...
                for (size_t i = 0; i < output_shapes.size(); ++i) {
                    ...
                    TF_RETURN_IF_ERROR(
                        c->MakeShapeFromPartialTensorShape(output_shapes[i], &output_shape_handle)
                    );
            ...
            absl::Status DimensionsFromShape(
                ShapeHandle shape,
                TensorFormat format,
            ...
            absl::Status ShapeFromDimensions(
                DimensionHandle batch_dim,
            ...
            namespace {
                ...
                )
                {
                    ...
                    if (!FormatFromString(data_format_str, &data_format)) {
                        return absl::InvalidArgumentError(
                            absl::StrCat("Invalid data format string: ", data_format_str)
                        );
                    }
                    FilterTensorFormat filter_format;
                    if (!FilterFormatFromString(filter_format_str, &filter_format)) {
                        return absl::InvalidArgumentError(
                            absl::StrCat("Invalid filter format string: ", filter_format_str)
                        );
                    }
                    ...
                    if (dilations.size() != 4) {
                        return absl::InvalidArgumentError(
                            absl::StrCat(
                                "Conv2D requires the dilation attribute to contain 4 values, but "
                                "got: ",
                                dilations.size()
                            )
                        );
                    ...
                    if (c->ValueKnown(input_depth_dim) && c->ValueKnown(filter_input_depth_dim)) {
                        ...
                        if (input_depth_value != filter_input_depth_value) {
                            ...
                            if (c->ValueKnown(output_depth_dim)) {
                                ...
                                if (num_groups == 0) {
                                    return absl::InvalidArgumentError(
                                        "Number of groups must not be 0"
                                    );
                                }
            ...
            absl::Status ConvShape(shape_inference::InferenceContext* c)
            {
                ...
                // Default case.
                if (dilations.empty()) {
                    for (int i = 0; i < standard_input_rank; ++i) {
                ...
                DimensionHandle output_depth_dim = c->Dim(filter_shape, filter_dim_index('O'));
                DimensionHandle filter_input_depth_dim;
                ...
                if (groups < 1) {
                    ...
                    c->ValueKnown(input_depth_dim) && c->Value(input_depth_dim) % groups != 0
                ) {
                    return absl::InvalidArgumentError("Number of groups should divide input depth");
                } else if (
                    c->ValueKnown(output_depth_dim) && c->Value(output_depth_dim) % groups != 0
                ) {
                    return absl::InvalidArgumentError(
            ...
            absl::Status Conv3DShape(shape_inference::InferenceContext* c)
            {
                ...
                if (c->ValueKnown(input_depth_dim) && c->ValueKnown(filter_input_depth_dim)) {
                    ...
                    if (input_depth_value != filter_input_depth_value) {
                        ...
                        if (c->ValueKnown(output_depth_dim)) {
                            int64_t output_depth_value = c->Value(output_depth_dim);
                            if (num_groups == 0) {
                                return absl::InvalidArgumentError("Number of groups must not be 0");
                            }
                            if (output_depth_value % num_groups != 0) {
                                return absl::InvalidArgumentError(
                                    absl::StrCat(
                ...
                if (data_format == "NCDHW") {
                    output_shape = c->MakeShape(
                        {batch_size_dim, output_depth_dim, output_planes, output_rows, output_cols}
                    );
                } else {
                    output_shape = c->MakeShape(
            ...
            absl::Status Conv2DBackpropInputShape(shape_inference::InferenceContext* c)
            {
                ...
                if (c->Rank(specified_input_grad_shape) == InferenceContext::kUnknownRank) {
                    TF_RETURN_IF_ERROR(
                        c->WithRank(specified_input_grad_shape, 4, &specified_input_grad_shape)
                    );
                }
            ...
            namespace {
                ...
                )
                {
                    ...
                    if (dilations.size() != 4) {
                        return absl::InvalidArgumentError(
                            absl::StrCat(
                                "DepthwiseConv2D requires the dilations attribute to contain 4 "
                                "values, "
                                "but got: ",
                                dilations.size()
                            )
            ...
            absl::Status AvgPoolShape(shape_inference::InferenceContext* c)
            {
                ...
                constexpr int num_spatial_dims = 2;
                DimensionHandle batch_size_dim =
                    c->Dim(input_shape, GetTensorDimIndex<num_spatial_dims>(data_format, 'N'));
                DimensionHandle in_rows_dim =
                    c->Dim(input_shape, GetTensorDimIndex<num_spatial_dims>(data_format, 'H'));
                DimensionHandle in_cols_dim =
                    c->Dim(input_shape, GetTensorDimIndex<num_spatial_dims>(data_format, 'W'));
                DimensionHandle depth_dim =
                    c->Dim(input_shape, GetTensorDimIndex<num_spatial_dims>(data_format, 'C'));
            ...
            absl::Status FusedBatchNormGradExShape(shape_inference::InferenceContext* c)
            {
                ...
                TF_RETURN_IF_ERROR(
                    c->ReplaceDim(y_backprop, channel_dim_index, channel_dim, &side_input_backprop)
                );
            ...
            absl::Status ReadDiagIndex(
                InferenceContext* c,
                const Tensor* diag_index_tensor,
            ...
            absl::Status MatrixDiagPartV2Shape(shape_inference::InferenceContext* c)
            {
                ...
                TF_RETURN_IF_ERROR(
                    ReadDiagIndex(c, diag_index_tensor, &lower_diag_index, &upper_diag_index)
                );
                ...
                if (num_rows != InferenceContext::kUnknownDim &&
                    ...
                    if (lower_diag_index != 0 && // For when num_rows or num_cols == 0.
                        ...
                        return absl::InvalidArgumentError("lower_diag_index is out of bound.");
                    }
                    if (upper_diag_index != 0 && // For when num_rows or num_cols == 0.
                        (-num_rows >= upper_diag_index || upper_diag_index >= num_cols)) {
                        return absl::InvalidArgumentError("upper_diag_index is out of bound.");
                    }
                    max_diag_len = std::min(
            ...
            absl::Status MatrixDiagV2Shape(shape_inference::InferenceContext* c)
            {
                ...
                if (num_rows == -1) {
                    ...
                    return absl::InvalidArgumentError("num_rows is too small");
                }
                if (num_cols == -1) {
                    num_cols = min_num_cols;
                } else if (num_cols < min_num_cols) {
                    return absl::InvalidArgumentError("num_cols is too small.");
                }
                ...
                if (lower_diag_index == upper_diag_index) {
                    TF_RETURN_IF_ERROR(
                        c->ReplaceDim(input_shape, input_rank - 1, output_row_dim, &output_shape)
                    );
                    TF_RETURN_IF_ERROR(
                    ...
                    TF_RETURN_IF_ERROR(
                        c->ReplaceDim(input_shape, input_rank - 2, output_row_dim, &output_shape)
                    );
                    TF_RETURN_IF_ERROR(
                        c->ReplaceDim(output_shape, input_rank - 1, output_col_dim, &output_shape)
                    );
                }
                c->set_output(0, output_shape);
                return absl::OkStatus();
            ...
            absl::Status
            MaxPoolShapeImpl(shape_inference::InferenceContext* c, bool supports_explicit_padding)
            {
                std::string data_format_str;
                TensorFormat data_format;
                absl::Status s = c->GetAttr("data_format", &data_format_str);
            ...
            template<typename T>
            absl::Status ReductionShapeHelper(
                const Tensor* reduction_indices_t,
            ...
            absl::Status ExplicitShapes(InferenceContext* c)
            {
                ...
                if (shapes.empty()) {
                    return absl::InternalError("shapes attribute is empty");
                }
            ...
            absl::Status FusedQuantizedConvShape(InferenceContext* c, int num_dims)
            {
                ...
                fused_sum = std::find(fused_ops.begin(), fused_ops.end(), "Sum") != fused_ops.end();
                fused_bias =
                    std::find(fused_ops.begin(), fused_ops.end(), "BiasAdd") != fused_ops.end();
                fused_requantize =
                    std::find(fused_ops.begin(), fused_ops.end(), "Requantize") != fused_ops.end();

...
// no "x").
//
// Implements ice::builder::generator::Attribute directly: get_full_type()/get_base_type()
...
class Shape : public ice::builder::generator::Attribute
{
public:
    ...
    // --- ice::builder::generator::Attribute — see class comment ---
    ...
    {
        return ice::sonic::StringRuntime{m_dtype.to_string()};
    }
...
inline ice::sonic::StringRuntime Shape::get_full_type() const
{
    return ice::sonic::StringRuntime{std::format("{}", *this)};
}

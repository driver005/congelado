...
// One function body — also a ice::builder::generator::Definition: a named thing with bound inputs
// (its arguments) and bound outputs (its return values). No attrs (a correct answer, not a
// stub — functions carry none).
class Function : public ice::builder::generator::Definition
{
public:
    ...
    std::unique_ptr<ice::builder::generator::Parameter>
    ...
    render(int indent_level = 0) const
    {
        ...
        hive.append(ice::sonic::StringRuntime{

...
export module transport_codec_shared:atom;
...
class Atom {
  public:
    ...
    static const DecodeIntResult<UInt> decode_int(std::span<const std::uint8_t> data, std::size_t &pos,
        ...
        const std::uint8_t first_byte = data[pos++];

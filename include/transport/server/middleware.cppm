...
template <typename Request, typename Response, std::uint8_t MiddlewareSize>
class Middleware {
  public:
    constexpr Middleware() : m_middleware{}, m_middleware_index{0} {}

    constexpr void push(MiddlewareFn<Request, Response> middleware) {
    ...
    // constexpr void
    // push_middleware(const std::array<MiddlewareFn<Request, Response>, MiddlewareSize> &middleware) noexcept {
    ...
    constexpr const std::array<MiddlewareFn<Request, Response>, MiddlewareSize> &get_middlewares() const noexcept {
        return m_middleware;
    }
  ...
  private:
    ...
    std::array<MiddlewareFn<Request, Response>, MiddlewareSize> m_middleware;

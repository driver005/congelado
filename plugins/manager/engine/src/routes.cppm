    ...
    Router(router, "/api")
        .add_router(
            Router(router, "/v1")
                .add_router(
                    Router(router, "/tasks")
                        .post([task](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                        ...
                        .add_route(
                            Route{"/:name"}
                                .get([task](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                                    task->get_definition(req, res, std::move(send));
                                })
                                .summary("Get task definition")
                                .response<model::TaskDef>()
                                .put([task](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                                    task->update_definition(req, res, std::move(send));
                                })
                                .summary("Update task definition")
                                .body<model::TaskDef>()
                                .response<model::TaskDef>()
                                .delt([task](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                        ...
                        .add_route(Route{"/:id/heartbeat"}
                                       .patch([task](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                        ...
                        .add_route(Route{"/search"}
                                       .post([search](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                ...
                .add_router(
                    Router(router, "/workflows")
                        .post([wf](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                        ...
                        .add_route(
                            Route{"/:name"}
                                .get([wf](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                                    wf->get_definition(req, res, std::move(send));
                                })
                                .summary("Get workflow definition")
                                .response<model::WorkflowDef>()
                                .put([wf](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                                    wf->update_definition(req, res, std::move(send));
                                })
                                .summary("Update workflow definition")
                                .body<model::WorkflowDef>()
                                .response<model::WorkflowDef>()
                                .delt([wf](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                ...
                .add_router(
                    Router(router, "/metadata")
                        .add_route(Route{"/tasks"}
                                       .get([meta](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                ...
                .add_router(
                    Router(router, "/query")
                        .post([query](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                ...
                .add_router(
                    Router(router, "/event_handlers")
                        .get([events](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                            events->list_handlers(req, res, std::move(send));
                        })
                        .summary("List event handlers")
                        .response<std::vector<model::EventHandler>>()
                        .post([events](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                        ...
                        .add_route(
                            Route{"/:name"}
                                ...
                                .put([events](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                                    events->update_handler(req, res, std::move(send));
                                })
                                .summary("Update event handler")
                                .body<model::EventHandler>()
                                .response<model::EventHandler>()
                                .delt([events](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                ...
                .add_router(
                    Router(router, "/schedules")
                        .get([schedules](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                            schedules->list_schedules(req, res, std::move(send));
                        })
                        .summary("List workflow schedules")
                        .response<std::vector<model::WorkflowSchedule>>()
                        .post([schedules](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                        ...
                        .add_route(
                            Route{"/:name"}
                                ...
                                .put([schedules](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                                    schedules->update_schedule(req, res, std::move(send));
                                })
                                .summary("Update workflow schedule")
                                .body<model::WorkflowSchedule>()
                                .response<model::WorkflowSchedule>()
                                .delt([schedules](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                ...
                .add_router(
                    Router(router, "/admin")
                        .add_route(Route{"/consistency/:exec_id"}
                                       .post([admin](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
                                           admin->consistency(req, res, std::move(send));
                                       })
                                       .summary("Re-run DAG-advance for a stuck execution"))
                        .add_route(Route{"/config"}
                                       .get([admin](interfaces::io::IRequest &req, interfaces::io::IResponse &res, std::function<void()> send) {
...
suite<"engine register_routes"> register_routes_suite = [] {
    "populates the OpenAPI Registry with a representative route from every handler domain (relative to whatever's already registered)"_test =
        [] {
            ...
            // bulk ops
            expect(has_route_with_summary(before, std::to_underlying(Method::POST),
                                          "Bulk-terminate workflow executions"));
            // metadata + health
            expect(has_route_with_summary(before, std::to_underlying(Method::GET),
            ...
            // admin
            expect(has_route_with_summary(before, std::to_underlying(Method::POST),
                                          "Re-run DAG-advance for a stuck execution"));
            expect(has_route_with_summary(before, std::to_underlying(Method::GET),
                                          "Show wired-in backend configuration"));
            // workflow (singular) search
            expect(has_route_with_summary(before, std::to_underlying(Method::POST),
                                          "Search indexed workflow projections"));
        };

...
public:
    ...
    ) noexcept
    {
        try {
            ...
            // escaping — a worker_id or task_type containing a `"` or `\` produces invalid
            // JSON, or worse, lets a crafted value inject extra JSON keys/fields into this
            // response. Same class of bug PollHandler::build_submit_json already documents for
            // output_data below.

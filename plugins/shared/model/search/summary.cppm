...
/// Connector itself (search backends own their own storage), just JSON-encoded at the call site.
class WorkflowSummary {
  public:
    WorkflowSummary() = default;

    void set_exec_id(ExecutionId exec_id) { m_exec_id = exec_id; }
    void set_workflow_type(std::string workflow_type) { m_workflow_type = std::move(workflow_type); }
    ...
    [[nodiscard]] const std::string &get_workflow_type() const noexcept { return m_workflow_type; }
...
/// @brief Read-model projection of a terminal TaskInstance, same "projector-built, backend-JSON-
/// encoded, never Connector-persisted" story as WorkflowSummary.
class TaskSummary {
  public:
    TaskSummary() = default;
    ...
    void set_workflow_exec_id(ExecutionId exec_id) { m_workflow_exec_id = exec_id; }
    ...
    void set_queue_wait_time_ms(std::uint64_t millis) noexcept { m_queue_wait_time_ms = millis; }
...
struct serde::Serializable<model::WorkflowSummary> {
    static constexpr auto fields() {
        return std::tuple{
            serde::FieldDesc<"exec_id", &model::WorkflowSummary::get_exec_id,
                             &model::WorkflowSummary::set_exec_id>{},
            serde::FieldDesc<"workflow_type", &model::WorkflowSummary::get_workflow_type,
                             &model::WorkflowSummary::set_workflow_type>{},
            serde::FieldDesc<"version", &model::WorkflowSummary::get_version,
                             &model::WorkflowSummary::set_version>{},
            serde::FieldDesc<"status", &model::WorkflowSummary::get_status,
                             &model::WorkflowSummary::set_status>{},
            serde::FieldDesc<"correlation_id", &model::WorkflowSummary::get_correlation_id,
                             &model::WorkflowSummary::set_correlation_id>{},
            serde::FieldDesc<"start_time", &model::WorkflowSummary::get_start_time,
                             &model::WorkflowSummary::set_start_time>{},
            serde::FieldDesc<"end_time", &model::WorkflowSummary::get_end_time,
                             &model::WorkflowSummary::set_end_time>{},
            serde::FieldDesc<"failed_task_names", &model::WorkflowSummary::get_failed_task_names,
...
struct serde::Serializable<model::TaskSummary> {
    static constexpr auto fields() {
        return std::tuple{
            serde::FieldDesc<"task_id", &model::TaskSummary::get_task_id,
                             &model::TaskSummary::set_task_id>{},
            serde::FieldDesc<"task_def_name", &model::TaskSummary::get_task_def_name,
                             &model::TaskSummary::set_task_def_name>{},
            serde::FieldDesc<"workflow_exec_id", &model::TaskSummary::get_workflow_exec_id,
                             &model::TaskSummary::set_workflow_exec_id>{},
            serde::FieldDesc<"status", &model::TaskSummary::get_status,
                             &model::TaskSummary::set_status>{},
            serde::FieldDesc<"scheduled_time", &model::TaskSummary::get_scheduled_time,
                             &model::TaskSummary::set_scheduled_time>{},
            serde::FieldDesc<"start_time", &model::TaskSummary::get_start_time,
                             &model::TaskSummary::set_start_time>{},
            serde::FieldDesc<"update_time", &model::TaskSummary::get_update_time,
                             &model::TaskSummary::set_update_time>{},
            serde::FieldDesc<"queue_wait_time_ms", &model::TaskSummary::get_queue_wait_time_ms,

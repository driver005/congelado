...
class WorkflowDef {
  public:
    ...
    void set_restartable(bool restartable) noexcept { m_restartable = restartable; }
    ...
    [[nodiscard]] bool get_restartable() const noexcept { return m_restartable; }
...
struct serde::Serializable<model::WorkflowDef> {
    ...
    static constexpr auto fields() {
        return std::tuple{
            ...
            serde::FieldDesc<"restartable", &model::WorkflowDef::get_restartable,
                       &model::WorkflowDef::set_restartable>{},
            serde::FieldDesc<"workflow_status_listener_enabled",

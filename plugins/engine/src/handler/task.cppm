  ...
  private:
    ...
    void poll_impl(interfaces::io::IRequest &req, interfaces::io::IResponse &res,
        ...
        m_ctx.get().get_connector().find_first<model::TaskInstance>(
            ...
            [this, &res, accept,
             send = std::move(send)](std::optional<model::TaskInstance> found) mutable noexcept {
                ...
                m_ctx.get().get_connector().find<model::TaskDef>(
                    claimed.get_def_name(), [this, &res, accept, claimed, send = std::move(send)](
                        ...
                        m_ctx.get().get_connector().update<model::TaskInstance>(
                            claimed,
                            [&res, accept, claimed, send = std::move(send)](bool oke) mutable {
                                if (!oke) {

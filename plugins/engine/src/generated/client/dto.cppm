...
class EventAction {
  public:
    ...
    [[nodiscard]] const std::string &getPayload() const noexcept { return m_payload; }
...
class WorkflowSchedule {
  public:
    ...
    void setWorkflowName(std::string value) { m_workflow_name = std::move(value); }
    void setWorkflowVersion(std::int64_t value) { m_workflow_version = std::move(value); }
    void setPaused(bool value) { m_paused = std::move(value); }
    void setLastFiredAt(std::optional<std::string> value) { m_last_fired_at = std::move(value); }
    void setCronExpression(std::string value) { m_cron_expression = std::move(value); }
    void setSeedVariables(std::string value) { m_seed_variables = std::move(value); }
    void setEnabled(bool value) { m_enabled = std::move(value); }

    [[nodiscard]] const std::string &getName() const noexcept { return m_name; }
    [[nodiscard]] const std::string &getWorkflowName() const noexcept { return m_workflow_name; }
    [[nodiscard]] const std::int64_t &getWorkflowVersion() const noexcept { return m_workflow_version; }
    [[nodiscard]] const bool &getPaused() const noexcept { return m_paused; }
    [[nodiscard]] const std::optional<std::string> &getLastFiredAt() const noexcept { return m_last_fired_at; }
    [[nodiscard]] const std::string &getCronExpression() const noexcept { return m_cron_expression; }
    [[nodiscard]] const std::string &getSeedVariables() const noexcept { return m_seed_variables; }
    [[nodiscard]] const bool &getEnabled() const noexcept { return m_enabled; }
...
class TaskNode {
  public:
    ...
    void setRefName(std::string value) { m_ref_name = std::move(value); }
    void setEdges(std::vector<TaskEdge> value) { m_edges = std::move(value); }
    void setJoinOn(std::vector<std::string> value) { m_join_on = std::move(value); }
    void setJoinType(std::string value) { m_join_type = std::move(value); }
    void setDynamicTasksInputKey(std::optional<std::string> value) { m_dynamic_tasks_input_key = std::move(value); }
    void setLoopBody(std::vector<std::string> value) { m_loop_body = std::move(value); }
    void setLoopCondition(std::optional<std::string> value) { m_loop_condition = std::move(value); }

    [[nodiscard]] const std::string &getTaskDefName() const noexcept { return m_task_def_name; }
    [[nodiscard]] const std::string &getRefName() const noexcept { return m_ref_name; }
    [[nodiscard]] const std::vector<TaskEdge> &getEdges() const noexcept { return m_edges; }
    [[nodiscard]] const std::vector<std::string> &getJoinOn() const noexcept { return m_join_on; }
    [[nodiscard]] const std::string &getJoinType() const noexcept { return m_join_type; }
    [[nodiscard]] const std::optional<std::string> &getDynamicTasksInputKey() const noexcept { return m_dynamic_tasks_input_key; }
    [[nodiscard]] const std::vector<std::string> &getLoopBody() const noexcept { return m_loop_body; }
    [[nodiscard]] const std::optional<std::string> &getLoopCondition() const noexcept { return m_loop_condition; }
...
class TaskInstance {
  public:
    ...
    void setNodeRef(std::string value) { m_node_ref = std::move(value); }
    ...
    void setDeadlineAt(std::optional<std::string> value) { m_deadline_at = std::move(value); }
    void setTimings(ExecutionTimings value) { m_timings = std::move(value); }
    void setNextRetryAt(std::optional<std::string> value) { m_next_retry_at = std::move(value); }
    void setSubWorkflowExecId(std::optional<std::string> value) { m_sub_workflow_exec_id = std::move(value); }
    ...
    [[nodiscard]] const std::string &getNodeRef() const noexcept { return m_node_ref; }
    ...
    [[nodiscard]] const std::optional<std::string> &getDeadlineAt() const noexcept { return m_deadline_at; }
    [[nodiscard]] const ExecutionTimings &getTimings() const noexcept { return m_timings; }
    [[nodiscard]] const std::optional<std::string> &getNextRetryAt() const noexcept { return m_next_retry_at; }
    [[nodiscard]] const std::optional<std::string> &getSubWorkflowExecId() const noexcept { return m_sub_workflow_exec_id; }
...
class WorkflowExecution {
  public:
    ...
    void setStatus(std::string value) { m_status = std::move(value); }
    void setDynamicNodes(std::vector<TaskNode> value) { m_dynamic_nodes = std::move(value); }
    void setDefName(std::string value) { m_def_name = std::move(value); }
    ...
    void setTimings(ExecutionTimings value) { m_timings = std::move(value); }
    void setParentExecId(std::optional<std::string> value) { m_parent_exec_id = std::move(value); }

    [[nodiscard]] const std::string &getExecId() const noexcept { return m_exec_id; }
    [[nodiscard]] const std::string &getStatus() const noexcept { return m_status; }
    [[nodiscard]] const std::vector<TaskNode> &getDynamicNodes() const noexcept { return m_dynamic_nodes; }
    [[nodiscard]] const std::string &getDefName() const noexcept { return m_def_name; }
    ...
    [[nodiscard]] const ExecutionTimings &getTimings() const noexcept { return m_timings; }
    [[nodiscard]] const std::optional<std::string> &getParentExecId() const noexcept { return m_parent_exec_id; }
...
class SignalBody {
  public:
    ...
    void setNodeRef(std::string value) { m_node_ref = std::move(value); }
    void setPayload(std::optional<std::string> value) { m_payload = std::move(value); }

    [[nodiscard]] const std::string &getNodeRef() const noexcept { return m_node_ref; }
    [[nodiscard]] const std::optional<std::string> &getPayload() const noexcept { return m_payload; }
...
class PollData {
  public:
    ...
    void setLastPollAt(std::string value) { m_last_poll_at = std::move(value); }

    [[nodiscard]] const std::string &getWorkerType() const noexcept { return m_worker_type; }
    [[nodiscard]] const std::string &getLastPollAt() const noexcept { return m_last_poll_at; }
...
class BulkExecIdsBody {
  public:
    ...
    void setExecIds(std::vector<std::string> value) { m_exec_ids = std::move(value); }

    [[nodiscard]] const std::vector<std::string> &getExecIds() const noexcept { return m_exec_ids; }
...
class BulkResult {
  public:
    ...
    void setExecId(std::string value) { m_exec_id = std::move(value); }
    void setSuccess(bool value) { m_success = std::move(value); }

    [[nodiscard]] const std::string &getExecId() const noexcept { return m_exec_id; }
    [[nodiscard]] const bool &getSuccess() const noexcept { return m_success; }
...
class EventHandler {
  public:
    ...
    void setName(std::string value) { m_name = std::move(value); }
    void setEvent(std::string value) { m_event = std::move(value); }
    void setCondition(std::optional<std::string> value) { m_condition = std::move(value); }
    void setActions(std::vector<EventAction> value) { m_actions = std::move(value); }
    void setActive(bool value) { m_active = std::move(value); }

    [[nodiscard]] const std::string &getName() const noexcept { return m_name; }
    [[nodiscard]] const std::string &getEvent() const noexcept { return m_event; }
    [[nodiscard]] const std::optional<std::string> &getCondition() const noexcept { return m_condition; }
    [[nodiscard]] const std::vector<EventAction> &getActions() const noexcept { return m_actions; }
    [[nodiscard]] const bool &getActive() const noexcept { return m_active; }
...
class ScheduleNextRun {
  public:
    ...
    void setAt(std::string value) { m_at = std::move(value); }

    [[nodiscard]] const std::string &getAt() const noexcept { return m_at; }
...
class SearchRequestBody {
  public:
    ...
    void setQuery(std::string value) { m_query = std::move(value); }
    void setSort(std::string value) { m_sort = std::move(value); }
    void setFreeText(std::string value) { m_free_text = std::move(value); }
    void setSize(std::int64_t value) { m_size = std::move(value); }
    void setStart(std::int64_t value) { m_start = std::move(value); }

    [[nodiscard]] const std::string &getQuery() const noexcept { return m_query; }
    [[nodiscard]] const std::string &getSort() const noexcept { return m_sort; }
    [[nodiscard]] const std::string &getFreeText() const noexcept { return m_free_text; }
    [[nodiscard]] const std::int64_t &getSize() const noexcept { return m_size; }
    [[nodiscard]] const std::int64_t &getStart() const noexcept { return m_start; }
...
class WorkflowDef {
  public:
    ...
    void setRestartable(bool value) { m_restartable = std::move(value); }
    void setWorkflowStatusListenerEnabled(bool value) { m_workflow_status_listener_enabled = std::move(value); }
    ...
    [[nodiscard]] const bool &getRestartable() const noexcept { return m_restartable; }
    [[nodiscard]] const bool &getWorkflowStatusListenerEnabled() const noexcept { return m_workflow_status_listener_enabled; }
...
class RerunBody {
  public:
    ...
    void setNodeRef(std::string value) { m_node_ref = std::move(value); }
    void setInput(std::string value) { m_input = std::move(value); }
...
class AdminConfig {
  public:
    ...
    void setDbConfigured(bool value) { m_db_configured = std::move(value); }
    void setSweepIntervalSeconds(std::int64_t value) { m_sweep_interval_seconds = std::move(value); }
    void setLuaBridgeConfigured(bool value) { m_lua_bridge_configured = std::move(value); }

    [[nodiscard]] const bool &getDbConfigured() const noexcept { return m_db_configured; }
    [[nodiscard]] const std::int64_t &getSweepIntervalSeconds() const noexcept { return m_sweep_interval_seconds; }
    [[nodiscard]] const bool &getLuaBridgeConfigured() const noexcept { return m_lua_bridge_configured; }
...
class TaskSubmitBody {
  public:
    ...
    void setResult(std::string value) { m_result = std::move(value); }
    void setOutputData(std::string value) { m_output_data = std::move(value); }
...
class TaskDef {
  public:
    ...
    void setName(std::string value) { m_name = std::move(value); }
    void setWorkerType(std::string value) { m_worker_type = std::move(value); }
    void setMaskedFields(std::vector<std::string> value) { m_masked_fields = std::move(value); }
    ...
    void setInputSchema(std::optional<std::string> value) { m_input_schema = std::move(value); }
    void setWaitDurationMs(std::optional<std::int64_t> value) { m_wait_duration_ms = std::move(value); }
    void setOutputSchema(std::optional<std::string> value) { m_output_schema = std::move(value); }
    void setTimeout(TimeoutPolicy value) { m_timeout = std::move(value); }
    void setDynamicTaskParam(std::optional<std::string> value) { m_dynamic_task_param = std::move(value); }
    void setDomain(std::optional<std::string> value) { m_domain = std::move(value); }
    void setRetry(RetryPolicy value) { m_retry = std::move(value); }
    void setEnforceSchema(bool value) { m_enforce_schema = std::move(value); }

    [[nodiscard]] const std::string &getName() const noexcept { return m_name; }
    [[nodiscard]] const std::string &getWorkerType() const noexcept { return m_worker_type; }
    [[nodiscard]] const std::vector<std::string> &getMaskedFields() const noexcept { return m_masked_fields; }
    ...
    [[nodiscard]] const std::optional<std::string> &getInputSchema() const noexcept { return m_input_schema; }
    [[nodiscard]] const std::optional<std::int64_t> &getWaitDurationMs() const noexcept { return m_wait_duration_ms; }
    [[nodiscard]] const std::optional<std::string> &getOutputSchema() const noexcept { return m_output_schema; }
    [[nodiscard]] const TimeoutPolicy &getTimeout() const noexcept { return m_timeout; }
    [[nodiscard]] const std::optional<std::string> &getDynamicTaskParam() const noexcept { return m_dynamic_task_param; }
    [[nodiscard]] const std::optional<std::string> &getDomain() const noexcept { return m_domain; }
    [[nodiscard]] const RetryPolicy &getRetry() const noexcept { return m_retry; }
    [[nodiscard]] const bool &getEnforceSchema() const noexcept { return m_enforce_schema; }
...
struct serde::Serializable<congelado_api_dto::WorkflowSchedule> {
    static constexpr auto fields() {
        ...
        return std::tuple{
            ...
            serde::FieldDesc<"workflow_name", &WorkflowSchedule::getWorkflowName, &WorkflowSchedule::setWorkflowName>{},
            serde::FieldDesc<"workflow_version", &WorkflowSchedule::getWorkflowVersion, &WorkflowSchedule::setWorkflowVersion>{},
            serde::FieldDesc<"paused", &WorkflowSchedule::getPaused, &WorkflowSchedule::setPaused>{},
            serde::FieldDesc<"last_fired_at", &WorkflowSchedule::getLastFiredAt, &WorkflowSchedule::setLastFiredAt>{},
            serde::FieldDesc<"cron_expression", &WorkflowSchedule::getCronExpression, &WorkflowSchedule::setCronExpression>{},
            serde::FieldDesc<"seed_variables", &WorkflowSchedule::getSeedVariables, &WorkflowSchedule::setSeedVariables>{},
            serde::FieldDesc<"enabled", &WorkflowSchedule::getEnabled, &WorkflowSchedule::setEnabled>{},
        };
    }
};
...
struct serde::Serializable<congelado_api_dto::TaskNode> {
    static constexpr auto fields() {
        ...
        return std::tuple{
            ...
            serde::FieldDesc<"dynamic_tasks_input_key", &TaskNode::getDynamicTasksInputKey, &TaskNode::setDynamicTasksInputKey>{},
            serde::FieldDesc<"loop_body", &TaskNode::getLoopBody, &TaskNode::setLoopBody>{},
            serde::FieldDesc<"loop_condition", &TaskNode::getLoopCondition, &TaskNode::setLoopCondition>{},
        };
    }
};
...
struct serde::Serializable<congelado_api_dto::TaskInstance> {
    static constexpr auto fields() {
        ...
        return std::tuple{
            ...
            serde::FieldDesc<"deadline_at", &TaskInstance::getDeadlineAt, &TaskInstance::setDeadlineAt>{},
            serde::FieldDesc<"timings", &TaskInstance::getTimings, &TaskInstance::setTimings>{},
            serde::FieldDesc<"next_retry_at", &TaskInstance::getNextRetryAt, &TaskInstance::setNextRetryAt>{},
            serde::FieldDesc<"sub_workflow_exec_id", &TaskInstance::getSubWorkflowExecId, &TaskInstance::setSubWorkflowExecId>{},
        };
    }
};
...
struct serde::Serializable<congelado_api_dto::WorkflowExecution> {
    static constexpr auto fields() {
        ...
        return std::tuple{
            ...
            serde::FieldDesc<"dynamic_nodes", &WorkflowExecution::getDynamicNodes, &WorkflowExecution::setDynamicNodes>{},
            ...
            serde::FieldDesc<"parent_exec_id", &WorkflowExecution::getParentExecId, &WorkflowExecution::setParentExecId>{},
        };
    }
};
...
struct serde::Serializable<congelado_api_dto::BulkExecIdsBody> {
    static constexpr auto fields() {
        ...
        return std::tuple{
            serde::FieldDesc<"exec_ids", &BulkExecIdsBody::getExecIds, &BulkExecIdsBody::setExecIds>{},
        };
    }
};
...
struct serde::Serializable<congelado_api_dto::EventHandler> {
    static constexpr auto fields() {
        ...
        return std::tuple{
            ...
            serde::FieldDesc<"condition", &EventHandler::getCondition, &EventHandler::setCondition>{},
...
struct serde::Serializable<congelado_api_dto::QueueUpdateBody> {
    static constexpr auto fields() {
        ...
        return std::tuple{
            ...
            serde::FieldDesc<"node_ref", &QueueUpdateBody::getNodeRef, &QueueUpdateBody::setNodeRef>{},
            serde::FieldDesc<"output_data", &QueueUpdateBody::getOutputData, &QueueUpdateBody::setOutputData>{},
        };
    }
};
...
struct serde::Serializable<congelado_api_dto::SearchRequestBody> {
    static constexpr auto fields() {
        ...
        return std::tuple{
            ...
            serde::FieldDesc<"free_text", &SearchRequestBody::getFreeText, &SearchRequestBody::setFreeText>{},
...
struct serde::Serializable<congelado_api_dto::WorkflowDef> {
    static constexpr auto fields() {
        ...
        return std::tuple{
            ...
            serde::FieldDesc<"restartable", &WorkflowDef::getRestartable, &WorkflowDef::setRestartable>{},
            serde::FieldDesc<"workflow_status_listener_enabled", &WorkflowDef::getWorkflowStatusListenerEnabled, &WorkflowDef::setWorkflowStatusListenerEnabled>{},
        };
    }
};
...
struct serde::Serializable<congelado_api_dto::AdminConfig> {
    static constexpr auto fields() {
        ...
        return std::tuple{
            serde::FieldDesc<"db_configured", &AdminConfig::getDbConfigured, &AdminConfig::setDbConfigured>{},
            serde::FieldDesc<"sweep_interval_seconds", &AdminConfig::getSweepIntervalSeconds, &AdminConfig::setSweepIntervalSeconds>{},
            serde::FieldDesc<"lua_bridge_configured", &AdminConfig::getLuaBridgeConfigured, &AdminConfig::setLuaBridgeConfigured>{},
        };
    }
};
...
struct serde::Serializable<congelado_api_dto::TaskSubmitBody> {
    static constexpr auto fields() {
        ...
        return std::tuple{
            ...
            serde::FieldDesc<"output_data", &TaskSubmitBody::getOutputData, &TaskSubmitBody::setOutputData>{},
        };
    }
};
...
struct serde::Serializable<congelado_api_dto::TaskDef> {
    static constexpr auto fields() {
        ...
        return std::tuple{
            ...
            serde::FieldDesc<"masked_fields", &TaskDef::getMaskedFields, &TaskDef::setMaskedFields>{},
            ...
            serde::FieldDesc<"wait_duration_ms", &TaskDef::getWaitDurationMs, &TaskDef::setWaitDurationMs>{},
            serde::FieldDesc<"output_schema", &TaskDef::getOutputSchema, &TaskDef::setOutputSchema>{},
            serde::FieldDesc<"timeout", &TaskDef::getTimeout, &TaskDef::setTimeout>{},
            serde::FieldDesc<"dynamic_task_param", &TaskDef::getDynamicTaskParam, &TaskDef::setDynamicTaskParam>{},
            serde::FieldDesc<"domain", &TaskDef::getDomain, &TaskDef::setDomain>{},
            serde::FieldDesc<"retry", &TaskDef::getRetry, &TaskDef::setRetry>{},
            serde::FieldDesc<"enforce_schema", &TaskDef::getEnforceSchema, &TaskDef::setEnforceSchema>{},
        };
    }
};
